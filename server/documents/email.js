...
@media only screen and (max-width: 600px) {
  ...
  invoice-link {
    ...
    <body>
        ...
        <div class="content">
            <img src=${
              company.logo
                ? company.logo
                : "https://res.cloudinary.com/dewfged1q/image/upload/v1703821009/CI_Logo_-_Final_zwtysb.png"
            } class="logo" />
            <h1 class="name">${
    ...
    Number(balanceDue) <= 0 ? "" : moment(dueDate).format("MMM Do YYYY")
      ...
      <div class"footer">
          <a href="https://cipherinvoice.netlify.app">
          <img class="footer-logo" src="https://res.cloudinary.com/dewfged1q/image/upload/v1703821009/CI_Logo_-_Final_zwtysb.png" alt="cipher-invoice"/>
        </a>
      </div>
    <p style="text-align: center">Generate your required invoice at Cipher Invoice Inc.</p>
    </div>
    </body>
</html>`;
}
